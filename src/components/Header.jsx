        ...
        <>
            <div className='container mx-auto xl:max-w-[1164px] xl:px-3 px6'>
                <ul className='flex items-center justify-center mb-12 gap-5 mt-5'>
                    <li><a href="" onClick={(e) => { e.preventDefault(); setOpentab(1) }} className='text-[30px] font-normal text-black'>Tab1</a></li>
                    <li><a href="" onClick={(e) => { e.preventDefault(); setOpentab(2) }} className='text-[30px] font-normal text-black'>Tab2</a></li>
                    <li><a href="" onClick={(e) => { e.preventDefault(); setOpentab(3) }} className='text-[30px] font-normal text-black'>Tab3</a></li>
                    <li><a href="" onClick={(e) => { e.preventDefault(); setOpentab(4) }} className='text-[30px] font-normal text-black'>Tab4</a></li>
                    <li><a href="" onClick={(e) => { e.preventDefault(); setOpentab(5) }} className='text-[30px] font-normal text-black'>Tab5</a></li>
                </ul>
